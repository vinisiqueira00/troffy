...
const MenuDrawer: React.FC = () => {
    const { opened, setOpened, searchFocused, setSearchFocused } =
        ...
        <div className={`${styles.menuDrawer} ${opened && styles.opened}`}>
            ...
            <nav className={styles.menuDrawerContent}>
                ...
                <form className={styles.menuDrawerSearch}>
                    <span
                        className={`${styles.menuDrawerSearchEdge} ${
                            searchFocused && styles.show
                        }`}
                    ></span>
                    ...
                    <input
                        ...
                        ref={(input) => {
                            setInput(searchFocused ? input : null);
                        }}
                    ...
                    <button
                        className={styles.menuDrawerSearchSubmit}
                        type="button"
                    >
                        {searchFocused ? (
                            <SearchOrangeIcon />
                ...
                <ul className={styles.menuDrawerLinks}>
                    ...
                    <li className={styles.menuDrawerLink}>
                        <p className={styles.menuDrawerLinkText}>
                            Skateboarding
                        </p>
                        <ArrowRightGrayIcon />
                    </li>
                    ...
                    <li
                        className={`${styles.menuDrawerLink} ${styles.linkHighlight}`}
                    >
                ...
                <footer className={styles.menuDrawerAuthArea}>
                    <p className={styles.menuDrawerAuthText}>
                        Venha e torne-se um colaborador troffy e aproveite todas
                        as nossas ofertas.
                    </p>
                    <div className={styles.menuDrawerAuthButtons}>
                        <button className={styles.menuDrawerAuthRegister}>
                            Cadastrar-me
                        </button>
                        <button className={styles.menuDrawerAuthLogin}>
                            Entrar
                        </button>
                    </div>
                </footer>
            ...
            <section
                className={`${styles.menuDrawerSearchResult} ${
                    opened && inputValue.length > 4 && styles.searchResultOpened
                }`}
            >
                <h5 className={styles.menuDrawerSearchResultQuery}>
                    <SearchOrangeIcon />
                    <p className={styles.menuDrawerSearchResultQueryText}>
                        {inputValue}
                    </p>
                </h5>
            </section>
