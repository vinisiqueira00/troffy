            ...
            <div className={styles.footerContent}>
                ...
                <div className={styles.footerMenu}>
                    <ul className={styles.footerMenuList}>
                        <li className={styles.footerMenuListTitle}>
                            <span className={styles.footerMenuListTitleText}>
                                Plataforma
                            </span>
                        </li>
                        <li className={styles.footerMenuListLink}>
                            <Link href="/temp">
                                <a className={styles.footerMenulistLinkText}>
                                    Home
                                </a>
                            </Link>
                        </li>
                ...
                <div className={styles.footerNewsletter}>
                    <p className={styles.footerNewsletterText}>
                        Vamos, cadastre-se para receber nossas ofertas
                        sensacionais! Está esperando o que, hein?! :D
                    </p>
                    <form action="/" className={styles.footerNewsletterForm}>
                        <input
                            className={styles.footerNewsletterFormInput}
                            type="email"
